...
/**
 * A configuration properties class that holds configuration settings for Secure Kafka
 ...
 */
@Configuration
@ConfigurationProperties(prefix = "ode.kafka.secure")
@Data
public class SecureKafkaProperties {
   ...
   */
  public Map<String, Object> buildSecureKafkaProperties() {
